...
import com.codecool.ElProyecteGrande.payload.security.LoginRequest;
import com.codecool.ElProyecteGrande.payload.security.SignupRequest;
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    ...
                    case "ROLE_MODERATOR":
                        ...
                        break;
                    default:
                        System.out.println("ARE ROLUL DE USER");
                        Role userRole = roleRepository.findByName(RoleType.ROLE_USER)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(userRole);
                }
